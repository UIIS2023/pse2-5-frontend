...
export class ChallengeFormComponent implements OnChanges, OnInit{
  ...
  constructor(private service: AdministrationService, private authService: AuthService, private router: Router,private layoutService: LayoutService) {}
  ngOnInit(): void {
