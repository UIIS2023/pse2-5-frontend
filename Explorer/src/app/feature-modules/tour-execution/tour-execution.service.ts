...
import { Secret, TourKeyPoints } from '../tour-authoring/model/tour-keypoints.model';
...
export class TourExecutionService {
  ...
  getSessionByTouristId(id: number): Observable<Session>{
    return this.http.get<Session>(environment.apiHost + 'tourist/session/getByTouristId/' + id);
  }
  ...
  getTourKeyPointSecret(keyPointId: number): Observable<Secret>{
    return this.http.get<Secret>(environment.apiHost + 'tourist/tourKeyPoint/secret/' + keyPointId);
  }
