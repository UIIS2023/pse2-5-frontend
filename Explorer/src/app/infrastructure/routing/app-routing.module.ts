...
import { TourProblemFormComponent } from 'src/app/feature-modules/marketplace/tour-problem-form/tour-problem-form.component';
...
import { MapViewComponent } from 'src/app/feature-modules/tour-authoring/map-view/map-view.component';
...
const routes: Routes = [
  ...
  {path: 'tourProblem',component:TourProblemFormComponent, canActivate: [AuthGuard]},
